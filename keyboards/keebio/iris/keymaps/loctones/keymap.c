...
//   //└────────┴────────┴────────┴───┬────┴───┬────┴───┬────┴───┬────┘        └───┬────┴───┬────┴───┬────┴───┬────┴────────┴────────┴────────┘
//                                     KC_LGUI, KC_ENT,  NAV,                       SYMBOLS, KC_SPACE, KC_RALT
//                                 // └────────┴────────┴────────┘                 └────────┴────────┴────────┘
//   ),
  // Navigation
  [LYR_NAV] = LAYOUT(
...
const rgblight_segment_t PROGMEM base_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, RGBLED_NUM, LYR_QWERTY_COLOR_HSV}  // Light all LEDs, starting with 0
);
const rgblight_segment_t PROGMEM nav_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, RGBLED_NUM, LYR_NAV_COLOR_HSV}  // Light all LEDs, starting with 0
);
const rgblight_segment_t PROGMEM symbols_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, RGBLED_NUM, LYR_SYMBOLS_COLOR_HSV}  // Light all LEDs, starting with 0
);
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(0, layer_state_cmp(state, LYR_QWERTY));
    return state;
}
